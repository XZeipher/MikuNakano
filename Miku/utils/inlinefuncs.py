...
from Miku import BOT_NAME, MESSAGE_DUMP_CHAT, SUDOERS, app, arq
from Miku.core.keyboard import ikb
from Miku.core.tasks import _get_tasks_text, all_tasks, rm_task
from Miku.core.types import InlineQueryResultCachedDocument
from Miku.modules.info import get_chat_info, get_user_info
from Miku.modules.music import download_youtube_audio
from Miku.utils.functions import test_speedtest
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        ...
        InlineQueryResultArticle(
            title="Support",
            description="Help Support Of This Repo.",
            input_message_content=InputTextMessageContent(
                "t.me/x"
            ),
...
async def alive_function(answers):
    ...
    msg = f"""
**[{BOT_NAME}](https://github.com/PrincesssGirlXD/MikuNakano):**
**MainBot:** `{bot_state}`
...
"""
    answers.append(
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/6ea413f776968a50e5402.jpg",
            input_message_content=InputTextMessageContent(
